  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Button
          onClick={() => setReviewDialog({ open: true, editing: null })}
          className="shrink-0"
        >
              ...
              {isLoading ? (
                ...
                items.map((review) => (
                  <ReviewRow
                    ...
                    onEdit={() =>
                      setReviewDialog({ open: true, editing: review })
                    }
      ...
      <ReviewDialog
        ...
        onOpenChange={(open: boolean) => {
          if (!open) setReviewDialog({ open: false, editing: null });
        }}
        editing={reviewDialog.editing}
        listingOptions={listingOptions}
        listingOptionsLoading={listingOptionsLoading}
        defaultListingId={listingId !== "all" ? listingId : undefined}
        onSaved={(message) => {
          showToast(message);
          void load(true);
        }}
