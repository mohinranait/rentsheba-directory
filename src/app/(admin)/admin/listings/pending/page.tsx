...
export default function AllPendingListing() {
  ...
  }, [page, pageSize, debouncedSearch, categoryId, locationId]);
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Manage and review pending listings submitted to your directory.
          </p>
        </div>
