  ...
  return (
    <section id="top" className="relative overflow-hidden bg-[#e8f2ec]">
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 py-16 lg:grid-cols-[1.03fr_.97fr] lg:px-8 lg:py-24">
        <div>
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-[#bdd4c6] bg-white/60 px-3 py-1.5 text-xs font-semibold text-[#36705e]">
          ...
          <div className="mt-9 flex max-w-2xl flex-col gap-2 rounded-2xl bg-white p-2 shadow-[0_18px_45px_rgba(36,79,59,.12)] sm:flex-row">
        ...
        <div className="relative hidden min-h-95 lg:block">
          <div className="absolute right-8 top-5 h-72 w-72 rounded-[45%] bg-[#d3f36b]/60 blur-[1px]" />
          <div className="absolute right-16 top-14 w-80 rounded-3xl border border-white/80 bg-white p-5 shadow-[0_25px_60px_rgba(50,90,68,.18)]">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="grid size-12 place-items-center rounded-2xl bg-[#dfeee4] text-lg font-bold text-[#2b6854]">
                  GL
                </div>
                <div>
            ...
            <div className="mt-5 flex items-center justify-between border-t border-[#edf1ee] pt-4 text-xs text-[#6e877e]">
              <span className="flex items-center gap-1">
                <MapPin className="size-3.5" /> Dhanmondi, Dhaka
              </span>
              <span className="rounded-full bg-[#edf7ef] px-2 py-1 font-semibold text-[#4b8b71]">
                Open now
              </span>
            </div>
          </div>
          <div className="absolute bottom-4 left-8 rounded-2xl border border-white bg-white p-4 shadow-[0_18px_40px_rgba(50,90,68,.13)]">
            <div className="flex items-center gap-3">
              <div className="grid size-10 place-items-center rounded-xl bg-[#e9ecf4] text-sm font-bold text-[#536686]">
                BC
              </div>
              <div>
