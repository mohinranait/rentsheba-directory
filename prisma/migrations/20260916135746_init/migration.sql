...
*/
-- CreateEnum
CREATE TYPE "ListingStatus" AS ENUM ('PENDING', 'APPROVED', 'REJECTED', 'SUSPENDED', 'EXPIRED', 'DRAFT');
...
-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('STRIPE', 'SSLCOMMERZ', 'OTHER');

-- CreateEnum
CREATE TYPE "PlanType" AS ENUM ('FREE', 'YEARLY');
...
-- CreateIndex
CREATE INDEX "Listing_categoryId_locationId_idx" ON "Listing"("categoryId", "locationId");

-- CreateIndex
CREATE INDEX "Listing_status_categoryId_locationId_idx" ON "Listing"("status", "categoryId", "locationId");
...
-- CreateIndex
CREATE UNIQUE INDEX "Location_slug_parentId_key" ON "Location"("slug", "parentId");
